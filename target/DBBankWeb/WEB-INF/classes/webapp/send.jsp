...
<body>
<div align="center">
    <h1>Transact - sending operation</h1>
    ...
    <form action="/main" method="get">
        ...
        Choose the account From<br><br>
        <p>Acc No:<input type="text" name="from"></p>
        Choose the account To<br><br>
        <p>Acc No:<input type="text" name="to"></p>
