...
<div align="center">
    ...
    <form action="/main" method="get">
        ...
        Choose the account<br><br>
        <p>Acc No:<input type="text" name="account" class="input-medium search-query"></p>
        <p>Amount of money:<input type="number" min="1" step="any" name="money" class="input-medium search-query"></p>
        ...
        <input type="submit" value="Refill" class="btn btn-primary">
    </form>
</div>
